...
export default function InputTable({navigation,...props}) {
  ...
  return (
    ...
    <View className="mt-10">
      <Text className="text-white  bg-green-500 from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"onPress={()=>navigation.navigate('Buttons')} >Start</Text>
    </View>
  </View>
  );
}
